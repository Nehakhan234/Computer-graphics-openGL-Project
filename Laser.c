...
GLint x1=250,y1=150,x2=350,y2=150,x3=350,y3=200,x4=250,y4=200;
...
void laser()
{
     ...
     for(i=0;i<30;i+=3)
     {
                      quad(x1+i,y1+i,x2+i,y2,x3+i,y3,x4+i,y4+i);
...
void display()
{
     ...
     Write("Monochromatic-single wavelenght"); 
...
int main(int argc,char **argv)
{
    ...
    glutCreateWindow("Laser-working and principle..");
